...
class BotTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals($response->baseResponse->content(), '{"result":false,"message":"The bot id field is required.","data":[]}');
    ...
    public function testDelete()
    {
        ...
        $response = $this->get('/create?' . http_build_query($params));
        $this->assertEquals($response->baseResponse->content(), '{"result":false,"message":"The bot id has already been taken.","data":[]}');
        $response->assertStatus(422);
