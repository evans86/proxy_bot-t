...
/**
 * Исходящие HTTPS-запросы к api.telegram.org (уведомления админки).
 * При блокировке Telegram из РФ — задайте HTTP-прокси в .env (см. http_basic.notify_telegram_http_proxy).
 */
